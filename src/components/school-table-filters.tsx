...
export function SchoolTableFilters({ provinces, regencies, districts, filters }: SchoolTableFiltersProps) {
  ...
  return (
    <section className="mb-6 rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
      <form method="GET" action="/admin/sekolah" className="flex flex-wrap items-end gap-4">
        <div className="flex-1 min-w-[200px]">
          <label htmlFor="filter-q" className="mb-1.5 block text-sm font-medium text-slate-700">
            Cari
          </label>
          <input
            id="filter-q"
            ...
            className="w-full rounded-md border border-slate-300 px-3 py-2 text-sm placeholder-slate-400 focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500"
          />
        </div>
